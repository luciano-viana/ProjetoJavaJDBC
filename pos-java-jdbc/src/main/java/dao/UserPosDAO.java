...
public class UserPosDAO {
	...
	//---------------------------------------------INSERT-------------------------------------------------------
	// Método publico que não precisa retornar nada, método para fazer "Insert" no BD
	...
	public List<Userposjava> listar() throws Exception{
		...
		PreparedStatement statement = connection.prepareStatement(sql);//passado o sql para o prepareStatement que prepara o sql
		ResultSet resultado = statement.executeQuery();//executado no banco de dados
		
		while (resultado.next()) {//Interar o resultado, enquanto tiver dados vai pecorrer a lista criando novos objetos e adicionar na lista
